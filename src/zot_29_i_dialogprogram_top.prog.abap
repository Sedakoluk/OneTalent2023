...
CLASS lcl_main_dialogp DEFINITION DEFERRED. "top kısmı classın altında kaldığı için program da görmedi
"böyle bi claasım var bekle ben bunu tanımlayacağım. DEFERRED.
